                                                    ...
                                                    <div class="card_text_head " style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; margin-bottom:10px"> 
                                                        <div class="card_text_left">
                                                            ...
                                                            @if($id_card->blood==1 && $role_id==2)
                                                                <div id="hBloodGroup">
                                                                    <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('student.region') : {{@$staff_student->bloodGroup!=""?@$staff_student->bloodGroup->base_setup_name:""}}</h3>
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </div>
