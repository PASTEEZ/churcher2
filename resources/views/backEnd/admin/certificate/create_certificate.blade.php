                                        ...
                                        <div class="col-lg-12 studentVariable d-none">
                                            <h4>
                                                ...
                                                <span class="text-primary">
                                                    ...
                                                    [registration_no] [member_id_no] [faculty] [session] [department] [academic] [semester] [semester_label]  [gender] [registration_date]
                                                    [category] [cast] [father_name] [mother_name] [marital_status] [email] [phone]
                                                    @else
                                                    [name] [date_of_birth] [present_address] [guardian] [created_at]
                                                    [registration_no] [member_id_no] [class] [section] [gender] [registration_date]
                                                    [category] [cast] [father_name] [mother_name] [marital_status] [email] [phone],
                                                    @endif
