                            ...
                            <div class="add-visitor">
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        ...
                                        <span class="text-primary">[name] [dob] [present_address] [guardian] [created_at] [registration_no] [member_id_no] [class] [section] [gender] [registration_date] [category] [cast] [father_name] [mother_name] [marital_status] [email] [phone]</span>
                                    </div>
                                </div>
