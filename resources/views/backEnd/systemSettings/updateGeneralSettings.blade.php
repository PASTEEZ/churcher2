                        ...
                        <div class="row mb-40">
                            ...
                            <div class="col-lg-6 d-flex relation-button">
                                ...
                                <div class="d-flex radio-btn-flex ml-30 mt-1 mt-1">
                                    ...
                                    <div class="mr-20">
                                        <input type="radio" name="multiple_roll" id="member_id_no" value="0" class="common-radio relationButton" {{@$editData->multiple_roll == "0"? 'checked': ''}}>
                                        <label for="member_id_no">@lang('common.disable')</label>
                                    </div>
                                </div>
                            </div>
