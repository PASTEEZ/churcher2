...
<section class="student-details">
    <div class="container-fluid p-0">
        ...
        <div class="row">
            @if(userPermission(2) && isMenuAllowToShow('academics'))
                <div class="col-lg-3 col-md-6">
                    <a href="{{ route('student_subject') }}" class="d-block">
                        <div class="white-box single-summery">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3>@lang('common.payment')</h3>
                                    <p class="mb-0">@lang('student.total_payment')</p>
                                </div>
            ...
            @endif
            @if(userPermission(3)  && isMenuAllowToShow('communicate'))
                <div class="col-lg-3 col-md-6">
            ...
            @endif
            @if(userPermission(4)  && isMenuAllowToShow('examination'))
                <div class="col-lg-3 col-md-6">
            ...
            @endif
            @if(userPermission(5) && (isMenuAllowToShow('online_exam') || moduleStatusCheck('OnlineExam')))
                <div class="col-lg-3 col-md-6">
            ...
            @endif
            @if(userPermission(6)  && isMenuAllowToShow('academics'))
            ...
            @endif
            @if(userPermission(7) && isMenuAllowToShow('library'))
                <div class="col-lg-3 col-md-6">
            ...
            @endif
            @if(userPermission(8)  && isMenuAllowToShow('homework'))
                <div class="col-lg-3 col-md-6">
            ...
            @endif
            @if(userPermission(9)  && isMenuAllowToShow('student_info'))
                <div class="col-lg-3 col-md-6">
                    <a href="{{ route('student_my_attendance') }}" class="d-block">
                        <div class="white-box single-summery">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3>@lang('student.current_month_attendance')</h3>
