                    ...
                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'session_student', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student']) }}
                        <div class="row">
                            ...
                            <div class="input-effect">
                                <input class="primary-input" type="text" name="registration_number" value="{{ isset($name)?$name:''}}">
                                        ...
                                        <div class="card-body">
                                            <div class="white-box"> 
                                                ...
                                                <div class="row mt-20">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <strong>@lang('reports.transcript_none'):</strong> {{ $studentDetails->registration_number }}
                                                    </div>
                                                </div>
                                                <div class="row mt-20">
