                    ...
                    <ul class="nav nav-tabs tabs_scroll_nav" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link @if (Session::get('staffDocuments') != 'active' && Session::get('staffTimeline') != 'active') active @endif"
                               href="#memberProfile" role="tab" data-toggle="tab">@lang('hr.profile')</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{Session::get('staffTimeline') == 'active'? 'active':''}}"
                               href="#staffTimeline" role="tab" data-toggle="tab">@lang('hr.timeline')</a>
                        </li>
                                ...
                                <table id="" class="table simple-table table-responsive school-table"
                                                    ...
                                                    @if($value->payroll_status == 'P')
                                                        <a class="modalLink" data-modal-size="modal-lg"
                                                           ...
                                                           href="{{route('view-payslip', $value->id)}}">
                                                            <button class="primary-btn small tr-bg"> @lang('common.view_payslip')</button>
                                                        </a>
                                                    @endif
                                                </td>
                                            </tr>
                                    ...
                                    @else
                                        <tr class="justify-content-center">
                                            <td colspan="7"
                                                class="justify-content-center text-center">@lang('hr.no_payroll_data')</td>
                                        </tr>
                                    @endif
                                    </tbody>
                                </table>
                                        ...
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-5 d-flex align-itemd-center">
                                                ...
                                                <a class="primary-btn icon-only fix-gr-bg ml-2"
                                                   onclick="deleteStaffDoc({{$staffDetails->id}},1)" data-id="1"
                                                   href="#">
                                    ...
                                    @if($staffDetails->resume != '')
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-5 d-flex align-itemd-center">
                                                ...
                                                <a class="primary-btn icon-only fix-gr-bg ml-2"
                                                   onclick="deleteStaffDoc({{$staffDetails->id}},2)" data-id="2"
                                                   href="#">
                                                    <span class="ti-trash"></span>
                                                </a>
                                            </td>
                                    ...
                                    @if($staffDetails->other_document != '')
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-5 d-flex align-itemd-center">
                                                ...
                                                <a class="primary-btn icon-only fix-gr-bg ml-2"
                                                   onclick="deleteStaffDoc({{$staffDetails->id}},3)" data-id="3"
                                                   href="#">
                                                    <span class="ti-trash"></span>
                                                </a>
                                            </td>
                                            ...
                                            <tr class="d-flex">
                                                ...
                                                <td class="col-5 d-flex align-itemd-center">
                                                    ...
                                                    <a class="primary-btn icon-only fix-gr-bg modalLink ml-2"
                                                       title="{{ __('hr.delete_document') }}" data-modal-size="modal-md"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 mt-30">
                                                    <div class="row no-gutters input-right-icon mt-35">
                                                        <div class="col">
                                                            <div class="input-effect">
                                                                <input class="primary-input" id="placeholderInput"
                                                                       type="text"
                                                        ...
                                                        <div class="col-auto">
                                                            <button class="primary-btn-small-input" type="button">
                                                                ...
                                                                <input type="file" class="d-none" id="browseFile"
                                                                       name="staff_upload_document" required>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="row mt-25">
                                                <div class="col-lg-12">
                                                    <div class="input-effect">
                                                        <input class="primary-input form-control{" type="text"
                                                               name="title" value="" id="title" required>
                                                        <span class="focus-border"></span>
                                        ...
                                        <div class="col-lg-12 mt-30">
                                            <div class="row no-gutters input-right-icon mt-35">
                                                <div class="col">
                                                    <div class="input-effect">
                                                        <input class="primary-input" id="placeholderFileFourName"
                                                               type="text"
