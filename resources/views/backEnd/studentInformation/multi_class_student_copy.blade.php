                            ...
                            @if (moduleStatusCheck('University'))
                                ...
                                <div class="col-lg-3 mt-25">
                                    <div class="input-effect md_mb_20">
                                        <input class="primary-input" type="text" name="member_id_no"
                                            value="{{ isset($member_id_no) ? $member_id_no : '' }}">
                                        ...
                                        <tbody class="d-block">
                                            @foreach ($student_detail->studentRecords as $record)
                                                <tr class="d-flex">
                                                    ...
                                                    @if (generalSetting()->multiple_roll == 1)
                                                        <td class="{{ $div }}">{{ $record->member_id_no }}</td>
                                                    @endif
                                                    <td class="{{ $div }}">
