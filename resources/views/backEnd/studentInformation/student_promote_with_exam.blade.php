                                ...
                                <tbody>
                                  ...
                                  <input type="hidden" name="promote[{{$student->studentinfo->id}}][result]"  value="{{ $student->result }}">
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="{{route('student_view',[$student->studentinfo->id]) }}"  target="_blank" rel="noopener noreferrer">  <h5 style="color:#A235EC">{{$student->studentinfo->member_id_no}}</h5></a> </td>
