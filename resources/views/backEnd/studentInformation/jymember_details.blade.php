...
@section('mainContent')
    ...
    @php
        if(isset($academic_year) || isset($class_id)){
            $ajax_url=url('jymembers-list-datatable?academic_year='.
            $academic_year.'&class='.
            $class_id.'&section='.
            $section.'&roll_no='.
            $roll_no.'&name='.$name);
        }else{
            $ajax_url = url('jymembers-list-datatable');
        }
    @endphp
@endsection
@section('script')
        ...
        $(document).ready(function() {
            $('.data-table').DataTable({
                ...
                "ajax": $.fn.dataTable.pipeline( {
                    url: "{{url('jymembers-list-datatable')}}",
                    data: {
                ...
                columns: [
                    ...
                    {data: 'gender.base_setup_name', name: 'gender.base_setup_name'},
                     {data: 'mobile', name: 'sm_jymembers.mobile'},
