...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
                    ...
                    <div class="white-box">
                        <div class="row">
                            ...
                            @else
                                ...
                                <div class="col-lg-2">
                                    <div class="input-effect sm_mb_20 sm2_mb_20 md_mb_20">
                                        <input class="primary-input" type="text" name="member_id_no" value="{{ isset($member_id_no)?$member_id_no:old('member_id_no')}}">
                                        <label>@lang('student.search_by_roll_no')</label>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
            ...
            <input type="hidden" id="roll" value="{{@$member_id_no}}">
    ...
    @php
        if(isset($church_year) || isset($age_group_id)){
            ...
            $section.'&member_id_no='.
            $member_id_no.'&name='.$name);
        }else{
