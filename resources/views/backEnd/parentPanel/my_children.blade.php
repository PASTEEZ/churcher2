            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <ul class="nav nav-tabs tabs_scroll_nav" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="#memberProfile" role="tab"
                               data-toggle="tab">@lang('student.profile')</a>
                        </li>
                        @if(generalSetting()->fees_status == 0 && isMenuAllowToShow('fees'))
                            <li class="nav-item">
                                <a class="nav-link" href="#memberpayment" role="tab"
                        ...
                        @endif
                        <li class="nav-item">
                            <a class="nav-link" href="#memberDocuments" role="tab"
                    ...
                    <div class="tab-content">
                                ...
                                @if(is_show('marital_status'))
                                    <div class="single-info">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7 col-md-7">
                                                <div class="">
                                                    @if(!empty($student_detail->marital_status))
                                                        {{@$student_detail->marital_status->base_setup_name}}
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <!-- End Profile Tab -->
                        <!-- Start Fees Tab -->
                        <div role="tabpanel" class="tab-pane fade" id="memberpayment">
                                        ...
                                        @foreach($exam_terms as $exam)
                                            ...
                                            @if($get_results)
                                                ...
                                                @php
                                                    ...
                                                    $temp_grade=[];
                                                    $total_gpa_point = 0;
                                                    $total_payment = count($get_results);
                                                    $optional_subject = 0;
                                                    $optional_gpa = 0;
                                                @endphp
                                                        ...
                                                        <table id="table_id" class="display school-table"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th>@lang('exam.position')
                                                                    : {{getStudentMeritPosition($record->age_group_id, $record->mgender_id, $exam->id, $record->id) ?? "null"}}</th>
                                                                <th>
                        ...
                        <!-- Start Documents Tab -->
                        <div role="tabpanel" class="tab-pane fade" id="memberDocuments">
                            <div class="white-box">
                                <table id="" class="table simple-table table-responsive school-table"
                                    ...
                                    @if(is_show('document_file_1'))
                                        @if($student_detail->document_file_1 != "")
                                            <tr class="d-flex">
                                                <td class="col-3">{{$student_detail->group_1}} </td>
                                    ...
                                    @if(is_show('document_file_2'))
                                        @if($student_detail->document_file_2 != "")
                                            <tr class="d-flex">
                                                <td class="col-3">{{$student_detail->group_2}}</td>
                                    ...
                                    @if(is_show('document_file_3'))
                                        @if($student_detail->document_file_3 != "")
                                            <tr class="d-flex">
                                                <td class="col-3">{{$student_detail->group_3}}</td>
                                    ...
                                    @if(is_show('document_file_4'))
                                        @if($student_detail->document_file_4 != "")
                                            <tr class="d-flex">
                                                <td class="col-3">{{$student_detail->group_4}}</td>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="studentTimeline">
                            <div class="white-box">
                                ...
                                <table id="" class="table simple-table table-responsive school-table"
                                    ...
                                    @foreach ($student_detail->studentRecords as $record)
                                        <tr class="d-flex">
                                            <td class="col-4">{{ $record->class->age_group_name }}</td>
                                            <td class="col-4">{{ $record->section->mgender_name }}</td>
                                            <td class="col-4">{{ $record->member_id_no }}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
