...
class CreateSmLanguagePhrasesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $d = [
            ...
            [0, 'select_church_year', 'Select Academic Year', 'Select Academic Year', 'একাডেমিক বছর নির্বাচন করুন', 'Select Academic Year'],
            ...
            [1, 'member_id_card', 'Student ID Card', 'Credencial de estudiante', 'শিক্ষার্থী আইডি কার্ড', 'Carde didentité détudiant'],
            ...
            [1, 'region', 'Region', 'Grupo sanguíneo', 'রক্তের গ্রুপ', 'Groupe sanguin'],
            ...
            [1, 'registration_no', 'Admission No', 'Admission No', 'ভর্তি নং', 'Admission No'],
            ...
            [1, 'member_id_no', 'Roll No', 'Roll No', 'ক্রমিক নাম্বার', 'Roll No'],
            ...
            [1, 'member_name', 'Student Name', 'Student Name', 'শিক্ষার্থীর নাম', 'Student Name'],
            ...
            [17, 'church_year', 'Academic Year', 'Año académico', 'শিক্ষাবর্ষ', 'Année académique'],
            ...
            [17, 'church_name', 'School Name', 'Nombre de la escuela', 'স্কুলের নাম', 'Nom de lécole'],
            [17, 'church_code', 'School Code', 'Código escolar', 'স্কুল কোড', 'Code détablissement'],
            ...
            [2, 'marital_status', 'Religion', 'Religión', 'ধর্ম', 'Religion'],
            [2, 'home_town', 'Caste', 'Casta', 'জাত', 'Caste'],
            ...
            [2, 'employer_name', 'Bank Name', 'Nombre del banco', 'ব্যাংকের নাম', 'Nom de banque'],
            ...
            [20, 'point7', 'For student "Region" use Id', 'Para el estudiante "Grupo de sangre" use ID', 'শিক্ষার্থীদের জন্য "ব্লাড গ্রুপ" আইডি ব্যবহার করুন', 'Pour les étudiants Groupe sanguin, utilisez lId'],
            ...
            [3, 'registration_number', 'Admission Nnumber', 'Admission Nnumber', 'ভর্তি নম্বর', 'Admission Nnumber'],
            ...
            [18, 'virtual_age_group_id', 'VClass ID', 'VClass ID', 'ভিস্লাস আইডি', 'VClass ID'],
            ...
            [18, 'cheque_details', 'Cheque Details', 'Cheque Details', 'বিশদ পরীক্ষা করুন', 'Cheque Details'],
            [18, 'copy_with_church_year', 'Copy With Academic Year', 'Copy With Academic Year', 'একাডেমিক বছর সহ অনুলিপি করুন', 'Copy With Academic Year'],
