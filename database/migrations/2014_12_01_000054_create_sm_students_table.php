...
class CreateSmStudentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sm_students', function (Blueprint $table) {
            ...
            $table->string('home_town', 200)->nullable();
            ...
            $table->string('communicant', 200)->nullable();
            $table->string('day_born', 200)->nullable();
            ...
            $table->string('group_1', 200)->nullable();
            $table->string('document_file_1', 200)->nullable();
            $table->string('group_2', 200)->nullable();
            $table->string('document_file_2', 200)->nullable();
            $table->string('group_3', 200)->nullable();
            $table->string('document_file_3', 200)->nullable();
            $table->string('group_4', 200)->nullable();
