...
class CreateSmsTemplatesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $allTempletes = [
            ...
            ['sms', 'student_library_book_issue', '', 'Dear [member_name], Library book  is issued to you studying in class: [age_group_name] , section: [mgender_name] with roll no:[member_id_no] On [issue_date] .Please find the details , Book Title: [book_title], Book No: [book_no], Due Date: [due_date], Thank You [church_name]', '', '[member_name], [age_group_name], [mgender_name],[member_id_no],[issue_date], [book_title], [book_no], [due_date], [church_name]'],
            ...
            ['sms', 'student_return_issue_book', '', 'Dear [member_name], Library book  is returned by you studying in class: [age_group_name] , section: [mgender_name] with roll no:[member_id_no] On [return_date] .Please find the details , Book Title: [book_title], Book No: [book_no], Issue Date: [issue_date], Due Date: [due_date], Thank You [church_name]', '', '[member_name], [age_group_name], [mgender_name], [member_id_no], [return_date], [issue_date], [book_title], [book_no], [due_date], [church_name]'],
