...
Route::group(['middleware' => ['XSS', 'subdomain']], function () {
    ...
    Route::group(['middleware' => ['StudentMiddleware']], function () {
        ...
        Route::post('member_upload_document', ['as' => 'student_upload_document', 'uses' => 'SmStudentAdmissionController@studentUploadDocument']);
        Route::get('member-download-document/{file_name}', 'Student\SmStudentPanelController@DownlodStudentDocument')->name('student-download-document')->middleware('userRolePermission:17');
        Route::post('member-logout', 'Auth\LoginController@logout')->name('student-logout');
        Route::get('member-profile', 'Student\SmStudentPanelController@studentDashboard')->name('student-profile')->middleware('userRolePermission:11');
        ...
        Route::get('member-dashboard', 'Student\SmStudentPanelController@studentProfile')->name('student-dashboard')->middleware('userRolePermission:1');
        ...
        Route::post('member-my-attendance', ['as' => 'student_my_attendance', 'uses' => 'Student\SmStudentPanelController@studentMyAttendanceSearch']);
        ...
        // Student Result
        Route::get('member-result', ['as' => 'student_result', 'uses' => 'Student\SmStudentPanelController@studentResult'])->middleware('userRolePermission:37');
        ...
        Route::get('member-study-material', ['as' => 'student_study_material', 'uses' => 'Student\SmStudentPanelController@studentStudyMaterial'])->middleware('userRolePermission:29');
        ...
        Route::get('member-others-download', ['as' => 'student_others_download', 'uses' => 'Student\SmStudentPanelController@othersDownload'])->middleware('userRolePermission:33');
        ...
        Route::get('member-download-content-document/{file_name}', 'Student\SmStudentPanelController@DownlodContent')->name('student-download-content-document')->middleware('userRolePermission:28');

        // Student Subject
        Route::get('member-service', ['as' => 'student_subject', 'uses' => 'Student\SmStudentPanelController@studentSubject'])->middleware('userRolePermission:49');
        ...
        // Student Noticeboard
        Route::get('member-noticeboard', ['as' => 'student_noticeboard', 'uses' => 'Student\SmStudentPanelController@studentNoticeboard'])->middleware('userRolePermission:48');
        
        // Student Teacher
        Route::get('member-leader', ['as' => 'student_teacher', 'uses' => 'Student\SmStudentPanelController@studentTeacher'])->middleware('userRolePermission:50');
    });
...
Route::get('member-direct-fees-total-payment/{record_id}', 'Student\SmFeesController@directFeesTotalPayment')->name('student-direct-fees-total-payment');
Route::post('member-direct-fees-total-payment', 'Student\SmFeesController@directFeesTotalPaymentSubmit')->name('student-direct-fees-total-payment-submit');
