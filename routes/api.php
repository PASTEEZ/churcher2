...
Route::group(['middleware' => ['XSS','auth:api','json.response']], function () {
    ...
    Route::get('class-id/{id}', 'SmApiController@get_age_group_name');
    Route::get('school/{church_id}/class-id/{id}', 'SmApiController@saas_get_age_group_name');
    Route::get('section-id/{id}', 'SmApiController@get_mgender_name');
    Route::get('school/{church_id}/section-id/{id}', 'SmApiController@saas_get_mgender_name');
    Route::get('teacher-id/{id}', 'SmApiController@get_teacher_name');
    Route::get('school/{church_id}/teacher-id/{id}', 'SmApiController@saas_get_teacher_name');
    Route::get('subject-id/{id}', 'SmApiController@get_subject_name');
    Route::get('school/{church_id}/subject-id/{id}', 'SmApiController@saas_get_subject_name');
    Route::get('room-id/{id}', 'SmApiController@get_room_name');
    Route::get('school/{church_id}/room-id/{id}', 'SmApiController@saas_get_room_name');
    Route::get('class-period-id/{id}', 'SmApiController@get_class_period_name');
    Route::get('school/{church_id}/class-period-id/{id}', 'SmApiController@saas_get_class_period_name');


    Route::get('visitor', ['as' => 'visitor', 'uses' => 'SmApiController@visitor_index']);
    Route::get('school/{church_id}/visitor', ['as' => 'saas_visitor', 'uses' => 'SmApiController@saas_visitor_index']);
    ...
    Route::get('school/{church_id}/visitor-edit/{id}', ['as' => 'saas_visitor_edit', 'uses' => 'SmApiController@saas_visitor_edit']);
    ...
    Route::get('school/{church_id}/visitor-delete/{id}', ['as' => 'saas_visitor_delete', 'uses' => 'SmApiController@saas_visitor_delete']);
    ...
    Route::get('school/{church_id}/complaint', 'SmApiController@saas_complaint_index');
    ...
    Route::get('school/{church_id}/complaint-edit/{id}', 'SmApiController@saas_complaint_edit');
    ...
    Route::get('school/{church_id}/postal-receive', 'SmApiController@saas_postal_receive_index');
    ...
    Route::post('school/{church_id}/postal-receive-edit/{id}', 'SmApiController@saas_postal_receive_show');
    ...
    Route::get('school/{church_id}/postal-receive-delete/{id}', 'SmApiController@saas_postal_receive_destroy');


    // Admin section postal-dispatch
    Route::get('postal-dispatch', 'SmApiController@postal_dispatch_index');
    Route::get('school/{church_id}/postal-dispatch', 'SmApiController@saas_postal_dispatch_index');
    ...
    Route::get('school/{church_id}/postal-dispatch-edit/{id}', 'SmApiController@saas_postal_dispatch_show');
    ...
    Route::get('school/{church_id}/postal-dispatch-delete/{id}', 'SmApiController@saas_postal_dispatch_destroy');
    // Phone Call Log
    ...
    // student list
   // Route::get('member_list', ['as' => 'student_list', 'uses' => 'SmApiController@studentDetails']);
   Route::get('student_list', ['as' => 'student_list', 'uses' => 'SmApiController@studentDetails']);
    Route::get('school/{church_id}/member-list', ['as' => 'saas_student_list', 'uses' => 'SmApiController@saas_studentDetails']);

    // student search

    Route::any('member-list-search', 'SmApiController@studentDetailsSearch');
    // Route::get('student-list-search', 'SmApiController@student_search_Details');
    Route::get('school/{church_id}/student-list-search', 'SmApiController@saas_student_search_Details');

    // student list
    Route::get('member-view/{id}', ['as' => 'student_view', 'uses' => 'SmApiController@studentView']);
    Route::get('school/{church_id}/student-view/{id}', ['as' => 'saas_student_view', 'uses' => 'SmApiController@saas_studentView']);
    // student delete
    Route::any('student-delete', ['as' => 'student_delete', 'uses' => 'SmApiController@studentDelete']);
    Route::any('school/{church_id}/student-delete', ['as' => 'saas_student_delete', 'uses' => 'SmApiController@saas_studentDelete']);
    // student edit
    Route::get('member-edit/{id}', ['as' => 'student_edit', 'uses' => 'SmApiController@studentEdit']);
    Route::get('school/{church_id}/student-edit/{id}', ['as' => 'saas_student_edit', 'uses' => 'SmApiController@saas_studentEdit']);


    // Student Attendance
    Route::get('member-attendance', ['as' => 'student_attendance', 'uses' => 'api\ApiSmStudentAttendanceController@student_attendance_index']);
    Route::get('school/{church_id}/student-attendance', ['as' => 'saas_student_attendance', 'uses' => 'api\ApiSmStudentAttendanceController@saas_student_attendance_index']);
    Route::post('member-search', 'api\ApiSmStudentAttendanceController@studentSearch');
    Route::post('school/{church_id}/student-search', 'api\ApiSmStudentAttendanceController@saaas_studentSearch');
    Route::get('member-search', 'api\ApiSmStudentAttendanceController@student_search_index');
    Route::get('school/{church_id}/student-search', 'api\ApiSmStudentAttendanceController@saas_student_search_index');

    Route::post('member-attendance-store', 'api\ApiSmStudentAttendanceController@studentAttendanceStore');
    Route::post('saas-student-attendance-store', 'api\ApiSmStudentAttendanceController@saas_studentAttendanceStore');

    Route::get('member-attendance-check', 'api\ApiSmStudentAttendanceController@studentAttendanceCheck');
    Route::get('school/{church_id}/student-attendance-check', 'api\ApiSmStudentAttendanceController@saas_studentAttendanceCheck');
    Route::get('member-attendance-store-first', 'api\ApiSmStudentAttendanceController@studentAttendanceStoreFirst');
    Route::get('school/{church_id}/student-attendance-store-first', 'api\ApiSmStudentAttendanceController@saas_studentAttendanceStoreFirst');
    Route::get('member-attendance-store-second', 'api\ApiSmStudentAttendanceController@studentAttendanceStoreSecond');
    Route::get('school/{church_id}/student-attendance-store-second', 'api\ApiSmStudentAttendanceController@saas_studentAttendanceStoreSecond');
    ...
    Route::get('member-subject-attendance-check', 'api\SubjectWiseAttendanceController@studentAttendanceCheck');
    Route::get('member-subject-attendance-store-first', 'api\SubjectWiseAttendanceController@studentAttendanceStoreFirst');
    Route::get('student-subject-attendance-store-second', 'api\SubjectWiseAttendanceController@studentAttendanceStoreSecond');


    // Student Attendance Report
    Route::get('member-attendance-report', ['as' => 'student_attendance_report', 'uses' => 'api\ApiSmStudentAttendanceController@studentAttendanceReport']);
    Route::get('school/{church_id}/member-attendance-report', ['as' => 'saas_student_attendance_report', 'uses' => 'api\ApiSmStudentAttendanceController@saas_studentAttendanceReport']);

    Route::post('member-attendance-report-search', ['as' => 'student_attendance_report_search', 'uses' => 'api\ApiSmStudentAttendanceController@studentAttendanceReportSearch']);
    Route::post('school/{church_id}/member-attendance-report-search', ['as' => 'saas_student_attendance_report_search', 'uses' => 'api\ApiSmStudentAttendanceController@saas_studentAttendanceReportSearch']);
    Route::get('member-attendance-report-search', 'api\ApiSmStudentAttendanceController@studentAttendanceReport_search');
    Route::get('school/{church_id}/member-attendance-report-search', 'api\ApiSmStudentAttendanceController@saas_studentAttendanceReport_search');

    // Student Category
    Route::get('student-category', ['as' => 'student_category', 'uses' => 'SmApiController@student_type_index']);
    Route::get('school/{church_id}/student-category', ['as' => 'saas_student_category', 'uses' => 'SmApiController@saas_student_type_index']);
    ...
    Route::get('school/{church_id}/student-category-edit/{id}', ['as' => 'saas_student_category_edit', 'uses' => 'SmApiController@saas_student_type_edit']);
    ...
    Route::get('school/{church_id}/student-category-delete/{id}', ['as' => 'saas_student_category_delete', 'uses' => 'SmApiController@saas_student_type_delete']);


    // Student Group Routes
    Route::get('member-profession', ['as' => 'student_group', 'uses' => 'SmApiController@student_group_index']);
    Route::get('school/{church_id}/member-profession', ['as' => 'saas_student_group', 'uses' => 'SmApiController@saas_student_group_index']);
    Route::post('member-profession-store', ['as' => 'student_group_store', 'uses' => 'SmApiController@student_group_store']);
    Route::post('saas-member-profession-store', ['as' => 'saas_student_group_store', 'uses' => 'SmApiController@saas_student_group_store']);
    Route::get('member-profession-edit/{id}', ['as' => 'student_group_edit', 'uses' => 'SmApiController@student_group_edit']);
    Route::get('school/{church_id}/member-profession-edit/{id}', ['as' => 'saas_student_group_edit', 'uses' => 'SmApiController@saas_student_group_edit']);
    Route::post('member-profession-update', ['as' => 'student_group_update', 'uses' => 'SmApiController@student_group_update']);
    Route::post('saas-member-profession-update', ['as' => 'saas_student_group_update', 'uses' => 'SmApiController@saas_student_group_update']);
    Route::get('member-professiondelete/{id}', ['as' => 'student_group_delete', 'uses' => 'SmApiController@student_group_delete']);
    Route::get('school/{church_id}/member-profession-delete/{id}', ['as' => 'saas_student_group_delete', 'uses' => 'SmApiController@saas_student_group_delete']);


    // Student Promote search
    Route::get('student-promote', ['as' => 'student_promote', 'uses' => 'SmApiController@studentPromote_index']);
    Route::get('school/{church_id}/student-promote', ['as' => 'saas_student_promote', 'uses' => 'SmApiController@saas_studentPromote_index']);

    Route::get('student-current-search', 'SmApiController@studentPromote');
    Route::get('school/{church_id}/student-current-search', 'SmApiController@saas_studentPromote');
    Route::post('student-current-search', 'SmApiController@studentCurrentSearch');
    Route::post('school/{church_id}/student-current-search', 'SmApiController@saas_studentCurrentSearch');
    ...
    Route::get('school/{church_id}/student-promote-store', 'SmApiController@saas_studentPromote_store');
    ...
    Route::get('school/{church_id}/disabled-student', ['as' => 'saas_disabled_student', 'uses' => 'SmApiController@saas_disabledStudent']);
    Route::post('disabled-student', ['as' => 'post_disabled_student', 'uses' => 'SmApiController@disabledStudentSearch']);
    Route::post('school/{church_id}/disabled-student', ['as' => 'saas_disabled_student_post', 'uses' => 'SmApiController@saas_disabledStudentSearch']);
    // -----------End Student Information---------------

    // -------------------Teacher Module------------------
    // Start Upload Content
    Route::get('upload-content', 'SmApiController@uploadContentList');
    Route::get('school/{church_id}/upload-content', 'SmApiController@saas_uploadContentList');
    ...
    Route::get('school/{church_id}/delete-upload-content/{id}', 'SmApiController@saas_deleteUploadContent');
    ...
    Route::get('school/{church_id}/assignment-list', 'SmApiController@saas_assignmentList');
    Route::get('study-metarial-list', 'SmApiController@studyMetarialList');
    Route::get('school/{church_id}/study-metarial-list', 'SmApiController@saas_studyMetarialList');
    Route::get('syllabus-list', 'SmApiController@syllabusList');
    Route::get('school/{church_id}/syllabus-list', 'SmApiController@saas_syllabusList');
    Route::get('other-download-list', 'SmApiController@otherDownloadList');
    Route::get('school/{church_id}/other-download-list', 'SmApiController@saas_otherDownloadList');
    ...
    Route::get('school/{church_id}/collect-fees', ['as' => 'saas_collect_fees', 'uses' => 'SmApiController@saas_collectFees']);
    Route::get('fees-collect-student-wise/{id}', ['as' => 'fees_collect_student_wise', 'uses' => 'SmApiController@collectFeesStudentApi']);
    Route::get('school/{church_id}/fees-collect-student-wise/{id}', ['as' => 'saas_fees_collect_student_wise', 'uses' => 'SmApiController@saas_collectFeesStudentApi']);
    ...
    Route::get('school/{church_id}/search-fees-payment', ['as' => 'saas_search_fees_payment', 'uses' => 'SmApiController@saas_searchFeesPayment']);
    Route::post('fees-payment-search', ['as' => 'fees_payment_search_post', 'uses' => 'SmApiController@feesPaymentSearch']);
    Route::post('school/{church_id}/fees-payment-search', ['as' => 'saas_fees_payment_search_post', 'uses' => 'SmApiController@saas_feesPaymentSearch']);
    Route::get('fees-payment-search', ['as' => 'fees_payment_search', 'uses' => 'SmApiController@search_Fees_Payment']);
    Route::get('school/{church_id}/fees-payment-search', ['as' => 'saas_fees_payment_search', 'uses' => 'SmApiController@saas_search_Fees_Payment']);

    //Fees Search due
    Route::get('search-fees-due', ['as' => 'search_fees_due', 'uses' => 'SmApiController@searchFeesDue']);
    Route::get('school/{church_id}/search-fees-due', ['as' => 'saas_search_fees_due', 'uses' => 'SmApiController@saas_searchFeesDue']);
    Route::post('fees-due-search', ['as' => 'fees_due_search', 'uses' => 'SmApiController@feesDueSearch']);
    Route::post('school/{church_id}/fees-due-search', ['as' => 'saas_fees_due_search', 'uses' => 'SmApiController@saas_feesDueSearch']);
    Route::get('fees-due-search', ['as' => 'fees_due_search_get', 'uses' => 'SmApiController@search_FeesDue']);
    Route::get('school/{church_id}/fees-due-search', ['as' => 'saas_fees_due_search_get', 'uses' => 'SmApiController@saas_search_FeesDue']);


    // Route::resource('fees-master', 'SmFeesMasterController');
    Route::post('fees-master-single-delete', 'SmApiController@deleteSingle');
    Route::post('school/{church_id}/fees-master-single-delete', 'SmApiController@saas_deleteSingle');
    Route::post('fees-master-group-delete', 'SmApiController@deleteGroup');
    Route::post('school/{church_id}/fees-master-group-delete', 'SmApiController@saas_deleteGroup');
    Route::get('fees-assign/{id}', ['as' => 'fees_assign', 'uses' => 'SmApiController@feesAssign']);
    Route::get('school/{church_id}/fees-assign/{id}', ['as' => 'saas_fees_assign', 'uses' => 'SmApiController@saas_feesAssign']);
    Route::get('fees-assign/{id}', ['as' => 'fees_assign_get', 'uses' => 'SmApiController@fees_Assign']);
    Route::get('school/{church_id}/fees-assign/{id}', ['as' => 'saas_fees_assign_get', 'uses' => 'SmApiController@saas_fees_Assign']);
    Route::post('fees-assign-search', 'SmApiController@feesAssignSearch');
    Route::post('school/{church_id}/fees-assign-search', 'SmApiController@saas_feesAssignSearch');

    // Fees Master
    Route::get('fees-master-store', ['as' => 'fees_master_add', 'uses' => 'SmApiController@feesMasterStore']);
    Route::get('school/{church_id}/fees-master-store', ['as' => 'saas_fees_master_add', 'uses' => 'SmApiController@saas_feesMasterStore']);
    Route::get('fees-master-update', ['as' => 'fees_master_update', 'uses' => 'SmApiController@feesMasterUpdate']);
    Route::get('school/{church_id}/fees-master-update', ['as' => 'saas_fees_master_update', 'uses' => 'SmApiController@saas_feesMasterUpdate']);

    // Fees Group routes
    Route::get('fees-group', ['as' => 'fees_group', 'uses' => 'ApiSmFeesGroupController@fees_group_index']);
    Route::get('school/{church_id}/fees-group', ['as' => 'saas_fees_group', 'uses' => 'ApiSmFeesGroupController@saas_fees_group_index']);
    Route::get('fees-group-store', ['as' => 'fees_group_store', 'uses' => 'ApiSmFeesGroupController@fees_group_store']);
    Route::get('school/{church_id}/fees-group-store', ['as' => 'saas_fees_group_store', 'uses' => 'ApiSmFeesGroupController@saas_fees_group_store']);
    Route::get('fees-group-edit/{id}', ['as' => 'fees_group_edit', 'uses' => 'ApiSmFeesGroupController@fees_group_edit']);
    Route::get('school/{church_id}/fees-group-edit/{id}', ['as' => 'saas_fees_group_edit', 'uses' => 'ApiSmFeesGroupController@saas_fees_group_edit']);
    Route::get('fees-group-update', ['as' => 'fees_group_update', 'uses' => 'ApiSmFeesGroupController@fees_group_update']);
    Route::get('school/{church_id}/fees-group-update', ['as' => 'saas_fees_group_update', 'uses' => 'ApiSmFeesGroupController@saas_fees_group_update']);
    Route::post('fees-group-delete', ['as' => 'fees_group_delete', 'uses' => 'ApiSmFeesGroupController@fees_group_delete']);
    Route::post('school/{church_id}/fees-group-delete', ['as' => 'saas_fees_group_delete', 'uses' => 'ApiSmFeesGroupController@saas_fees_group_delete']);

    // Fees type routes
    Route::get('fees-type', ['as' => 'fees_type', 'uses' => 'SmApiController@fees_type_index']);
    Route::get('school/{church_id}/fees-type', ['as' => 'saas_fees_type', 'uses' => 'SmApiController@saas_fees_type_index']);
    ...
    Route::get('school/{church_id}/fees-type-edit/{id}', ['as' => 'saas_fees_type_edit', 'uses' => 'SmApiController@saas_fees_type_edit']);
    ...
    Route::get('school/{church_id}/fees-type-delete/{id}', ['as' => 'saas_fees_type_delete', 'uses' => 'SmApiController@saas_fees_type_delete']);

    // Fees Discount routes
    Route::get('fees-discount', ['as' => 'fees_discount', 'uses' => 'SmApiController@fees_discount_index']);
    Route::get('school/{church_id}/fees-discount', ['as' => 'saas_fees_discount', 'uses' => 'SmApiController@saas_fees_discount_index']);
    ...
    Route::get('school/{church_id}/fees-discount-edit/{id}', ['as' => 'saas_fees_discount_edit', 'uses' => 'SmApiController@saas_fees_discount_edit']);
    ...
    Route::get('school/{church_id}/fees-discount-delete/{id}', ['as' => 'saas_fees_discount_delete', 'uses' => 'SmApiController@saas_fees_discount_delete']);
    Route::get('fees-discount-assign/{id}', ['as' => 'fees_discount_assign', 'uses' => 'SmApiController@feesDiscountAssign']);
    Route::get('school/{church_id}/fees-discount-assign/{id}', ['as' => 'saas_fees_discount_assign', 'uses' => 'SmApiController@saas_feesDiscountAssign']);
    Route::post('fees-discount-assign-search', 'SmApiController@feesDiscountAssignSearch');
    Route::post('school/{church_id}/fees-discount-assign-search', 'SmApiController@saas_feesDiscountAssignSearch');
    Route::get('fees-discount-assign-store', 'SmApiController@feesDiscountAssignStore');
    Route::get('school/{church_id}/fees-discount-assign-store', 'SmApiController@saas_feesDiscountAssignStore');

    Route::get('fees-generate-modal/{amount}/{member_id}/{type}', 'SmApiController@feesGenerateModal');
    Route::get('school/{church_id}/fees-generate-modal/{amount}/{member_id}/{type}', 'SmApiController@saas_feesGenerateModal');
    Route::get('fees-discount-amount-search', 'SmApiController@feesDiscountAmountSearch');
    Route::get('school/{church_id}/fees-discount-amount-search', 'SmApiController@saas_feesDiscountAmountSearch');
    // delete fees payment
    Route::post('fees-payment-delete', 'SmApiController@feesPaymentDelete');
    Route::post('school/{church_id}/fees-payment-delete', 'SmApiController@saas_feesPaymentDelete');

    // Fees carry forward
    Route::get('fees-forward', ['as' => 'fees_forward', 'uses' => 'SmApiController@feesForward']);
    Route::get('school/{church_id}/fees-forward', ['as' => 'saas_fees_forward', 'uses' => 'SmApiController@saas_feesForward']);
    Route::post('fees-forward-search', 'SmApiController@feesForwardSearch');
    Route::post('school/{church_id}/fees-forward-search', 'SmApiController@saas_feesForwardSearch');
    Route::get('fees-forward-search', 'SmApiController@fees_Forward');
    Route::get('school/{church_id}/fees-forward-search', 'SmApiController@saas_fees_Forward');

    Route::post('fees-forward-store', 'SmApiController@feesForwardStore');
    Route::post('school/{church_id}/fees-forward-store', 'SmApiController@saas_feesForwardStore');
    Route::get('fees-forward-store', 'SmApiController@Fees_fward');
    Route::get('school/{church_id}/fees-forward-store', 'SmApiController@saas_Fees_fward');
    ...
    Route::get('school/{church_id}/profit', ['as' => 'saas_profit', 'uses' => 'SmApiController@saas_profit']);
    Route::post('search-profit-by-date', ['as' => 'search_profit_by_date', 'uses' => 'SmApiController@searchProfitByDate']);
    Route::post('school/{church_id}/search-profit-by-date', ['as' => 'saas_search_profit_by_date', 'uses' => 'SmApiController@saas_searchProfitByDate']);
    Route::get('search-profit-by-date', ['as' => 'search_profit_by_date_get', 'uses' => 'SmApiController@Accounts_Profit']);
    Route::get('school/{church_id}/search-profit-by-date', ['as' => 'saas_search_profit_by_date_get', 'uses' => 'SmApiController@saas_Accounts_Profit']);

    // add income routes
    Route::get('add-income', ['as' => 'add_income', 'uses' => 'SmApiController@income_index']);
    Route::get('school/{church_id}/add-income', ['as' => 'saas_add_income', 'uses' => 'SmApiController@saas_income_index']);
    ...
    Route::get('school/{church_id}/add-income-edit/{id}', ['as' => 'saas_add_income_edit', 'uses' => 'SmApiController@saas_income_edit']);
    ...
    Route::post('school/{church_id}/add-income-delete', ['as' => 'saas_add_income_delete', 'uses' => 'SmApiController@saas_income_delete']);
    ...
    Route::get('school/{church_id}/payment-method', ['as' => 'saas_payment_method', 'uses' => 'SmApiController@saas_payment_index']);
    ...
    Route::get('school/{church_id}/payment-method-edit/{id}', ['as' => 'saas_payment_method_edit', 'uses' => 'SmApiController@saas_payment_edit']);
    ...
    Route::get('school/{church_id}/payment-method-delete/{id}', ['as' => 'saas_payment_method_delete', 'uses' => 'SmApiController@saas_payment_delete']);
    ...
    Route::get('school/{church_id}/staff-directory', ['as' => 'saas_staff_directory', 'uses' => 'SmApiController@saas_staffList']);
    Route::get('staff-roles', ['as' => 'staff_roles', 'uses' => 'SmApiController@staffRoles']);
    Route::get('school/{church_id}/staff-roles', ['as' => 'saas_staff_roles', 'uses' => 'SmApiController@saas_staffRoles']);
    Route::get('staff-list/{role_id}', ['as' => 'staff_dlist', 'uses' => 'SmApiController@roleStaffList']);
    Route::get('school/{church_id}/staff-list/{role_id}', ['as' => 'saas_staff_dlist', 'uses' => 'SmApiController@saas_roleStaffList']);
    Route::get('staff-view/{id}', ['as' => 'staff_view', 'uses' => 'SmApiController@staffView']);
    Route::get('school/{church_id}/staff-view/{id}', ['as' => 'saas_staff_view', 'uses' => 'SmApiController@saas_staffView']);
    Route::get('search-staff', 'SmApiController@staff_List');
    Route::get('school/{church_id}/search-staff', 'SmApiController@saas_staff_List');
    Route::post('search-staff', ['as' => 'searchStaff', 'uses' => 'SmApiController@searchStaff']);
    Route::post('school/{church_id}/search-staff', ['as' => 'saas_searchStaff', 'uses' => 'SmApiController@saas_searchStaff']);
    Route::get('deleteStaff/{id}', 'SmApiController@deleteStaff');
    Route::get('school/{church_id}/deleteStaff/{id}', 'SmApiController@saas_deleteStaff');

    //Staff Attendance
    Route::get('staff-attendance', ['as' => 'staff_attendance', 'uses' => 'SmApiController@staffAttendance']);
    Route::get('school/{church_id}/staff-attendance', ['as' => 'saas_staff_attendance', 'uses' => 'SmApiController@saas_staffAttendance']);
    ...
    Route::get('school/{church_id}/staff-attendance-report', ['as' => 'saas_staff_attendance_report', 'uses' => 'SmApiController@saas_staffAttendanceReport']);
    ...
    Route::post('school/{church_id}/staff-attendance-report-search', ['as' => 'saas_staff_attendance_report_search', 'uses' => 'SmApiController@saas_staffAttendanceReportSearch']);
    ...
    Route::get('school/{church_id}/approve-leave', 'SmApiController@saas_Approve_Leave_index');
    ...
    Route::get('school/{church_id}/approve-leave-edit/{id}', 'SmApiController@saas_Approve_Leave_edit');
    Route::get('staffNameByRole', 'SmApiController@staffNameByRole');
    Route::get('school/{church_id}/staffNameByRole', 'SmApiController@saas_staffNameByRole');
    Route::post('update-approve-leave', 'SmApiController@updateApproveLeave');
    Route::post('school/{church_id}/update-approve-leave', 'SmApiController@saas_updateApproveLeave');
    Route::get('view-leave-details-approve/{id}', 'SmApiController@viewLeaveDetails');
    Route::get('school/{church_id}/view-leave-details-approve/{id}', 'SmApiController@saas_viewLeaveDetails');
    //End Approve Leave Request

    //Start Apply Leave
    Route::get('apply-leave', 'SmApiController@apply_leave_index');
    Route::get('school/{church_id}/apply-leave', 'SmApiController@saas_apply_leave_index');
    ...
    Route::get('school/{church_id}/apply-leave-edit/{id}', 'SmApiController@saas_apply_leave_show');
    ...
    Route::get('school/{church_id}/view-leave-details-apply/{id}', 'SmApiController@saas_view_Leave_Details');
    Route::get('delete-apply-leave/{id}', 'SmApiController@apply_leave_destroy');
    Route::get('school/{church_id}/delete-apply-leave/{id}', 'SmApiController@saas_apply_leave_destroy');
    ...
    Route::get('school/{church_id}/student-apply-leave', 'Parent\SmParentPanelController@saas_leaveApply');
    ...
    Route::get('school/{church_id}/class-routine-new', ['as' => 'saas_class_routine_new', 'uses' => 'SmApiController@saas_classRoutine']);
    ...
    Route::get('student-routine-view/{member_id}/{record_id}', 'api\ApiSmClassRoutineController@studentClassRoutine');
    ...
    Route::post('school/{church_id}/class-routine-new', 'SmApiController@saas_classRoutineSearch');

    //assign subject
    Route::get('assign-subject', ['as' => 'assign_subject', 'uses' => 'SmApiController@assignSubject']);
    Route::get('school/{church_id}/assign-subject', ['as' => 'saas_assign_subject', 'uses' => 'SmApiController@saas_assignSubject']);
    Route::get('assign-subject-create', ['as' => 'assign_subject_create', 'uses' => 'SmApiController@assigSubjectCreate']);
    Route::get('school/{church_id}/assign-subject-create', ['as' => 'saas_assign_subject_create', 'uses' => 'SmApiController@saas_assigSubjectCreate']);
    Route::post('assign-subject-search', ['as' => 'assign_subject_search', 'uses' => 'SmApiController@assignSubjectSearch']);
    Route::post('school/{church_id}/assign-subject-search', ['as' => 'saas_assign_subject_search', 'uses' => 'SmApiController@saas_assignSubjectSearch']);
    Route::get('assign-subject-search', 'SmApiController@assign_Subject_Create');
    Route::get('school/{church_id}/assign-subject-search', 'SmApiController@saas_assign_Subject_Create');
    Route::post('assign-subject-store', 'SmApiController@assignSubjectStore');
    Route::post('school/{church_id}/assign-subject-store', 'SmApiController@saas_assignSubjectStore');
    Route::get('assign-subject-store', 'SmApiController@assignSubject_Create');
    Route::get('school/{church_id}/assign-subject-store', 'SmApiController@saas_assignSubject_Create');
    Route::post('assign-subject', 'SmApiController@assignSubjectFind');
    Route::post('school/{church_id}/assign-subject', 'SmApiController@saas_assignSubjectFind');
    Route::get('assign-subject-get-by-ajax', 'SmApiController@assignSubjectAjax');
    Route::get('school/{church_id}/assign-subject-get-by-ajax', 'SmApiController@saas_assignSubjectAjax');
    ...
    Route::get('school/{church_id}/subject', ['as' => 'saas_subject', 'uses' => 'SmApiController@saas_subject_index']);
    ...
    Route::get('school/{church_id}/subject-edit/{id}', ['as' => 'saas_subject_edit', 'uses' => 'SmApiController@saas_subject_edit']);
    ...
    Route::get('school/{church_id}/subject-delete/{id}', ['as' => 'saas_subject_delete', 'uses' => 'SmApiController@saas_subject_delete']);

    // Class route
    Route::get('membership-type', ['as' => 'class', 'uses' => 'SmApiController@class_index']);
    Route::get('church/{church_id}/class', ['as' => 'saas_class', 'uses' => 'SmApiController@saas_class_index']);
    Route::post('membership-type-store', ['as' => 'class_store', 'uses' => 'SmApiController@class_store']);
    Route::post('saas-membership-type-store', ['as' => 'saas_class_store', 'uses' => 'SmApiController@saas_class_store']);
    Route::get('membership-type-edit/{id}', ['as' => 'class_edit', 'uses' => 'SmApiController@class_edit']);
    Route::get('church/{church_id}/class-edit/{id}', ['as' => 'saas_class_edit', 'uses' => 'SmApiController@saas_class_edit']);
    Route::post('membership-type-update', ['as' => 'class_update', 'uses' => 'SmApiController@class_update']);
    Route::post('saas-membership-type-update', ['as' => 'saas_class_update', 'uses' => 'SmApiController@saas_class_update']);
    Route::get('membership-type-delete/{id}', ['as' => 'class_delete', 'uses' => 'SmApiController@class_delete']);
    Route::get('church/{church_id}/class-delete/{id}', ['as' => 'saas_class_delete', 'uses' => 'SmApiController@saas_class_delete']);

    //Class Section routes
    Route::get('section', ['as' => 'section', 'uses' => 'SmApiController@Section_index']);
    Route::get('school/{church_id}/section', ['as' => 'saas_section', 'uses' => 'SmApiController@saas_Section_index']);
    ...
    Route::get('school/{church_id}/section-edit/{id}', ['as' => 'saas_section_edit', 'uses' => 'SmApiController@saas_Section_edit']);
    ...
    Route::get('school/{church_id}/section-delete/{id}', ['as' => 'saas_section_delete', 'uses' => 'SmApiController@saas_Section_delete']);
    ...
    Route::get('school/{church_id}/student-class-routine/{id}', 'SmApiController@saas_class_Routine');
    //--------------- End Academic Module--------------
    ...
    Route::get('school/{church_id}/homework-list', ['as' => 'saas_homework-list', 'uses' => 'api\ApiSmHomeWorkController@saas_homeworkList']);
    Route::post('homework-list', ['as' => 'homework-list_post', 'uses' => 'api\ApiSmHomeWorkController@searchHomework']);
    Route::post('school/{church_id}/homework-list', ['as' => 'saas_homework-list_post', 'uses' => 'SmApiController@saas_searchHomework']);
    Route::get('evaluation-homework/{age_group_id}/{mgender_id}/{homework_id}', ['as' => 'evaluation-homework', 'uses' => 'api\ApiSmHomeWorkController@evaluationHomework']);
    
    Route::get('school/{church_id}/evaluation-homework/{age_group_id}/{mgender_id}/{homework_id}', ['as' => 'saas-evaluation-homework', 'uses' => 'api\ApiSmHomeWorkController@saas_evaluationHomework']);
    
    Route::post('evaluate-homework', ['as' => 'evaluate-homework', 'uses' => 'api\ApiSmHomeWorkController@saveHomeworkEvaluationData']);
     Route::post('school/{church_id}/evaluate-homework', ['as' => 'saas-evaluate-homework', 'uses' => 'api\ApiSmHomeWorkController@saasSaveHomeworkEvaluationData']);
    ...
    Route::get('school/{church_id}/homework-list/{id}', 'api\ApiSmHomeWorkController@saas_homework_List_Teacher');
    //--------------- End Homework Module--------------
    ...
    Route::get('school/{church_id}/notice-list', 'SmApiController@saas_noticeList');
    Route::get('send-message', 'SmApiController@sendMessage');
    Route::get('school/{church_id}/send-message', 'SmApiController@saas_sendMessage');
    ...
    Route::get('school/{church_id}/edit-notice/{id}', 'SmApiController@saas_editNotice');
    ...
    Route::get('school/{church_id}/delete-notice-view/{id}', 'SmApiController@saas_deleteNoticeView');
    Route::get('send-email-sms-view', 'SmApiController@sendEmailSmsView');
    Route::get('school/{church_id}/send-email-sms-view', 'SmApiController@saas_sendEmailSmsView');
    Route::get('delete-notice/{id}', 'SmApiController@deleteNotice');
    Route::get('school/{church_id}/delete-notice/{id}', 'SmApiController@saas_deleteNotice');

    //Event
    Route::resource('event', 'api\ApiSmEventController');
    Route::get('delete-event-view/{id}', 'SmApiController@deleteEventView');
    Route::get('school/{church_id}/delete-event-view/{id}', 'SmApiController@saas_deleteEventView');
    Route::get('delete-event/{id}', 'SmApiController@deleteEvent');
    Route::get('school/{church_id}/delete-event/{id}', 'SmApiController@saas_deleteEvent');
    ...
    Route::get('school/{church_id}/book-list', 'api\ApiSmBookController@saas_Library_index');
    ...
    Route::get('school/{church_id}/edit-book/{id}', 'api\ApiSmBookController@saas_editBook');
    ...
    Route::get('school/{church_id}/delete-book-view/{id}', 'api\ApiSmBookController@saas_deleteBookView');
    Route::get('delete-book/{id}', 'api\ApiSmBookController@deleteBook');
    Route::get('school/{church_id}/delete-book/{id}', 'api\ApiSmBookController@saas_deleteBook');
    Route::get('member-list', 'SmApiController@memberList');
    Route::get('school/{church_id}/member-list', 'SmApiController@saas_memberList');
    Route::get('issue-books/{member_type}/{id}', 'SmApiController@issueBooks');
    Route::get('school/{church_id}/issue-books/{member_type}/{id}', 'SmApiController@saas_issueBooks');
    ...
    Route::get('school/{church_id}/return-book-view/{id}', 'SmApiController@saas_returnBookView');
    Route::get('return-book/{id}', 'SmApiController@returnBook');
    Route::get('school/{church_id}/return-book/{id}', 'SmApiController@saas_returnBook');
    Route::get('all-issed-book', 'SmApiController@allIssuedBook');
    Route::get('school/{church_id}/all-issed-book', 'SmApiController@saas_allIssuedBook');
    Route::get('search-issued-book', 'SmApiController@searchIssuedBook');
    Route::get('school/{church_id}/search-issued-book', 'SmApiController@saas_searchIssuedBook');
    Route::get('search-issued-book', 'SmApiController@all_IssuedBook');
    Route::get('school/{church_id}/search-issued-book', 'SmApiController@saas_all_IssuedBook');
    ...
    Route::get('school/{church_id}/library-member-role', 'SmApiController@saas_member_role');
    Route::get('cancel-membership/{id}', 'SmApiController@cancelMembership');
    Route::get('school/{church_id}/cancel-membership/{id}', 'SmApiController@saas_cancelMembership');
    ...
    Route::get('school/{church_id}/delete-item-category-view/{id}', 'SmApiController@saas_deleteItemCategoryView');
    Route::get('delete-item-category/{id}', 'SmApiController@deleteItemCategory');
    Route::get('school/{church_id}/delete-item-category/{id}', 'SmApiController@saas_deleteItemCategory');
    ...
    Route::post('school/{church_id}/assign-vehicle-delete', 'SmApiController@saas_Assign_Vehicle_delete');
    ...
    Route::get('school/{church_id}/student-transport-report', ['as' => 'saas_student_transport_report', 'uses' => 'SmApiController@saas_studentTransportReportApi']);
    ...
    Route::post('school/{church_id}/student-transport-report', ['as' => 'saas_student_transport_report_post', 'uses' => 'SmApiController@saas_studentTransportReportSearch']);
    ...
    Route::get('school/{church_id}/student-dormitory-report', ['as' => 'saas_student_dormitory_report', 'uses' => 'SmApiController@saas_studentDormitoryReport']);
    Route::post('student-dormitory-report', ['as' => 'student_dormitory_report_post', 'uses' => 'SmApiController@studentDormitoryReportSearch']);
    Route::post('school/{church_id}/student-dormitory-report', ['as' => 'saas_student_dormitory_report_post', 'uses' => 'api\ApiSmDormitoryListController@saas_studentDormitoryReportSearch']);
    ...
    //Student Report
    Route::get('member-report', ['as' => 'student_report', 'uses' => 'SmApiController@studentReport']);
    Route::post('member-report', ['as' => 'saas_student_report', 'uses' => 'SmApiController@studentReportSearch']);
    ...
    //Student history
    Route::get('member-history', ['as' => 'student_history', 'uses' => 'SmApiController@studentHistory']);
    Route::post('member-history-search', ['as' => 'student_history_search_post', 'uses' => 'SmApiController@studentHistorySearch']);
    Route::get('member-history-search', ['as' => '_post', 'uses' => 'SmApiController@student_History']);

    // student login report
    Route::get('member-login-report', ['as' => 'student_login_report', 'uses' => 'SmApiController@studentLoginReport']);
    Route::post('member-login-search', ['as' => 'student_login_search_post', 'uses' => 'SmApiController@studentLoginSearch']);
    Route::get('member-login-search', ['as' => 'student_login_search_repost', 'uses' => 'SmApiController@student_Login_Report']);

    // student & parent reset password
    Route::post('reset-member-password', 'SmApiController@resetStudentPassword');
    ...
    // Class Report
    Route::get('group-report', ['as' => 'class_report', 'uses' => 'SmApiController@classReport']);
    Route::post('group-report', ['as' => 'class_report_post', 'uses' => 'SmApiController@classReportSearch']);
    ...
    Route::get('student-exam-schedule/{member_id}', ['as' => 'student-exam-schedule', 'uses' => 'api\ApiSmExamRoutineController@studentRoutine']);
    ...
    //General Settings
    Route::get('general-settings/{church_id}', 'SmApiController@generalSettingsView');
    ...
    Route::get('member-homework/{user_id}/{record_id}', 'api\ApiSmHomeWorkController@studentHomework');
    Route::post('member-upload-homework','api\ApiSmHomeWorkController@studentUploadHomework');
    Route::get('school/{church_id}/student-homework/{user_id}/{record_id}', 'api\ApiSmHomeWorkController@saas_studentHomework');
     Route::post('school/{church_id}/student-upload-homework','api\ApiSmHomeWorkController@saas_studentUploadHomework');
    Route::get('member-dashboard/{id}', 'SmApiController@studentDashboard');
    Route::get('school/{church_id}/member-dashboard/{id}', 'SmApiController@saas_studentDashboard');
    Route::get('member-my-attendance/{id}/{record_id}', 'api\ApiSmStudentAttendanceController@studentMyAttendanceSearchAPI');
    Route::get('school/{church_id}/member-my-attendance/{id}/{record_id}', 'api\ApiSmStudentAttendanceController@saas_studentMyAttendanceSearchAPI');
    Route::get('member-noticeboard/{id}', 'SmApiController@studentNoticeboard');
    Route::get('school/{church_id}/student-noticeboard/{id}', 'SmApiController@saas_studentNoticeboard');
    ...
    Route::get('member-service/{id}/{record_id}', 'SmApiController@studentSubjectApi');
    Route::get('school/{church_id}/studentSubject/{id}/{record_id}', 'SmApiController@saas_studentSubjectApi');
    Route::get('student-library/{id}', 'SmApiController@studentLibrary');
    Route::get('school/{church_id}/student-library/{id}', 'SmApiController@saas_studentLibrary');
    Route::get('studentleader/{id}', 'api\ApiSmStudentPanelController@studentTeacherApi');
    Route::get('school/{church_id}/studentTeacher/{user_id}/{record_id}', 'api\ApiSmStudentPanelController@saas_studentTeacherApi');
    ...
    Route::get('school/{church_id}/studentAssignment/{user_id}/{record_id}', 'api\ApiSmStudyMaterialController@saas_studentAssignmentApi');
    Route::get('studentDocuments/{user_id}/{record_id}', 'api\ApiSmStudyMaterialController@studentsDocumentApi');
    Route::get('school/{church_id}/studentDocuments/{user_id}/{record_id}', 'api\ApiSmStudyMaterialController@saas_studentsDocumentApi');

    Route::get('student-dormitory', 'SmApiController@studentDormitoryApi');
    Route::get('school/{church_id}/student-dormitory', 'SmApiController@saas_studentDormitoryApi');

    Route::get('student-exam_schedule/{id}', 'SmApiController@studentExamScheduleApi');
    Route::get('school/{church_id}/student-exam_schedule/{id}', 'SmApiController@saas_studentExamScheduleApi');

    Route::get('member-timeline/{id}', 'SmApiController@studentTimelineApi');
    Route::get('school/{church_id}/student-timeline/{id}', 'SmApiController@saas_studentTimelineApi');

    Route::get('student-online-exam/{user_id}/{record_id}', 'api\ApiSmExamController@studentOnlineExamApi');
    Route::get('school/{church_id}/student-online-exam/{user_id}/{record_id}', 'api\ApiSmExamController@saas_studentOnlineExamApi');
    Route::get('choose-exam/{user_id}/{record_id}', 'api\ApiSmExamController@chooseExamApi');
    Route::get('school/{church_id}/choose-exam/{user_id}/{record_id}', 'api\ApiSmExamController@saas_chooseExamApi');
    Route::get('online-exam-result/{user_id}/{exam_id}/{record_id}', 'api\ApiSmExamController@examResultApi');
    Route::get('school/{church_id}/online-exam-result/{user_id}/{exam_id}/{record_id}', 'api\ApiSmExamController@saas_examResultApi');
    Route::get('getGrades/{marks}', 'SmApiController@getGrades');
    Route::get('school/{church_id}/getGrades/{marks}', 'SmApiController@saas_getGrades');
    ...
    Route::get('school/{church_id}/exam-list/{user_id}/{record_id}', 'api\ApiSmExamController@saas_examListApi');
    Route::get('exam-schedule/{user_id}/{exam_id}/{record_id}', 'api\ApiSmExamController@examScheduleApi');
    Route::get('school/{church_id}/exam-schedule/{user_id}/{exam_id}/{record_id}', 'api\ApiSmExamController@saas_examScheduleApi');
    Route::get('exam-result/{user_id}/{exam_id}/{record_id}', 'api\ApiSmExamController@examResult_Api');
    Route::get('school/{church_id}/exam-result/{user_id}/{exam_id}/{record_id}', 'api\ApiSmExamController@saas_examResult_Api');

    //Add new exam setup
    Route::get('new-exam-setup', 'api\ApiSmExamController@NewExamSetup');
    Route::get('school/{church_id}/new-exam-setup', 'api\ApiSmExamController@saas_NewExamSetup');
    Route::get('new-exam-schedule', 'api\ApiSmExamController@NewExamSchedule');
    Route::get('school/{church_id}/new-exam-schedule', 'api\ApiSmExamController@saas_NewExamSchedule');

    Route::any('change-password', 'SmApiController@updatePassowrdStoreApi');
    Route::any('school/{church_id}/change-password', 'SmApiController@saas_updatePassowrdStoreApi');
    // exam routine 
    ...
    Route::get('school/{church_id}/child-list/{id}', 'api\ApiSmParentPanelController@saas_childListApi');
    Route::get('child-info/{id}', 'SmApiController@childProfileApi');
    Route::get('school/{church_id}/child-info/{id}', 'SmApiController@saas_childProfileApi');
    Route::get('child-fees/{id}', 'SmApiController@collectFeesChildApi');
    Route::get('school/{church_id}/child-fees/{id}', 'SmApiController@saas_collectFeesChildApi');
    Route::get('child-class-routine/{id}', 'SmApiController@classRoutineApi');
    Route::get('school/{church_id}/child-class-routine/{id}', 'SmApiController@saas_classRoutineApi');
    Route::get('child-homework/{id}', 'SmApiController@childHomework');
    Route::get('school/{church_id}/child-homework/{id}', 'SmApiController@saas_childHomework');

    Route::get('child-attendance/{id}/{record_id}', 'SmApiController@childAttendanceAPI');
    Route::get('school/{church_id}/child-attendance/{id}/{record_id}', 'SmApiController@saas_childAttendanceAPI');

    Route::get('childInfo/{id}', 'api\ApiSmParentPanelController@childInfo');
    Route::get('school/{church_id}/childInfo/{id}', 'api\ApiSmParentPanelController@saas_childInfo');

    Route::get('parent-about', 'SmApiController@aboutApi');
    Route::get('school/{church_id}/parent-about', 'SmApiController@saas_aboutApi');
    ...
    Route::any('search-member', 'api\ApiSmStudentController@searchStudent');
    Route::any('school/{church_id}/search-member', 'api\ApiSmStudentController@saas_searchStudent');
    ...
    // https://infixedu.com/api/search-student?member_id_no=28229
    Route::get('my-routine/{user_id}', 'api\ApiSmClassRoutineController@teacherClassRoutine');
    Route::get('school/{church_id}/my-routine/{id}', 'api\ApiSmClassRoutineController@sassTeacherClassRoutine');
    Route::get('membershiptype-routine/{user_id}/{class}/{section}', 'api\ApiSmClassRoutineController@sectionRoutine');
    Route::get('school/{church_id}/section-routine/{user_id}/{class}/{section}', 'SmApiController@saas_sectionRoutine');
    Route::get('class-section/{id}', 'SmApiController@classSection');
    Route::get('school/{church_id}/class-section/{id}', 'SmApiController@saas_classSection');
    Route::get('subject/{id}', 'SmApiController@subjectsName');
    Route::get('school/{church_id}/subject/{id}', 'SmApiController@saas_subjectsName');


    Route::get('leader-group-list', 'SmApiController@teacherClassList');
    Route::get('school/{church_id}/teacher-class-list', 'SmApiController@saas_teacherClassList');
    Route::get('leader-membership-list', 'SmApiController@teacherSectionList');
    Route::get('school/{church_id}/teacher-section-list', 'SmApiController@saas_teacherSectionList');


    Route::get('my-attendance/{id}', 'api\ApiSmStaffAttendanceController@teacherMyAttendanceSearchAPI');
    Route::get('school/{church_id}/my-attendance/{id}', 'api\ApiSmStaffAttendanceController@saas_teacherMyAttendanceSearchAPI');
    Route::get('staff-leave-type', 'SmApiController@leaveTypeList');
    Route::get('school/{church_id}/staff-leave-type', 'SmApiController@saas_leaveTypeList');
    ...
    Route::get('school/{church_id}/staff-apply-list/{id}', 'SmApiController@saas_staffLeaveList');

    // Route::get('upload-content-type', 'teacher\SmAcademicsController@contentType');
    Route::any('leader-upload-content', 'SmApiController@uploadContent');
    ...
    Route::get('school/{church_id}/content-list', 'api\ApiSmTeacherController@saasUploadContentList');
    Route::get('school/{church_id}/admin-content-list', 'api\ApiSmTeacherController@saas_contentList');
    Route::get('delete-content/{id}', 'api\ApiSmTeacherController@deleteContent');
    Route::get('school/{church_id}/delete-content/{id}', 'api\ApiSmTeacherController@saas_deleteContent');
   ...
   Route::get('pending-leave/{user_id}', 'api\ApiSmLeaveController@pendingLeave');
    ...
    Route::get('school/{church_id}/pending-leave', 'SmApiController@saas_pendingLeave');
    Route::get('approved-leave', 'SmApiController@approvedLeave');
    Route::get('school/{church_id}/approved-leave', 'SmApiController@saas_approvedLeave');
    ...
    Route::get('school/{church_id}/reject-leave', 'api\ApiSmLeaveController@saas_rejectLeave');
    ...
    Route::get('school/{church_id}/update-leave', 'SmApiController@saas_updateLeave');
    ...
    Route::get('set-fcm-token', 'SmApiController@setFcmToken');
    Route::any('school/{church_id}/set-token', 'SmApiController@saas_setToken');

    Route::get('group-token', 'SmApiController@groupToken');
    Route::get('school/{church_id}/group-token', 'SmApiController@saas_groupToken');
    ...
    Route::get('school/{church_id}/room-type-list', 'SmApiController@saas_roomTypeList');
    ...
    Route::get('school/{church_id}/room-delete/{id}', 'SmApiController@saas_deleteRoom');

    Route::get('dormitory-list', 'SmApiController@dormitoryList');
    Route::get('school/{church_id}/dormitory-list', 'SmApiController@saas_dormitoryList');
    ...
    Route::get('school/{church_id}/delete-dormitory/{id}', 'SmApiController@saas_deleteDormitory');

    Route::get('driver-list', 'SmApiController@getDriverList');
    Route::get('school/{church_id}/driver-list', 'SmApiController@saas_getDriverList');
    ...
    Route::get('school/{church_id}/user-demo', 'SmApiController@SaasDemoUser');
    ...
    Route::any('member-my-payment', 'SmApiController@studentFeesPayment');
    Route::any('school/{church_id}/student-fees-payment', 'SmApiController@saas_studentFeesPayment');

    Route::get('banks/{church_id}', 'api\ApiSmSaasBankController@saas_bankList');
    Route::post('saas-child-bank-slip-store', 'api\ApiSmSaasBankController@saas_childBankSlipStore');
    Route::get('school/{church_id}/studentSyllabus/{user_id}/{record_id}', 'api\ApiSmStudyMaterialController@saas_studentSyllabusApi');
    Route::get('school/{church_id}/studentOtherDownloads/{user_id}/{record_id}', 'api\ApiSmStudyMaterialController@saas_studentOtherDownloadsApi');
    Route::get('school/{church_id}/room-list', 'api\ApiSmSaasBankController@saas_roomList');
    Route::any('saas-book-category', 'api\ApiSmSaasBankController@saas_bookCategory');
    Route::get('my-leave-type/{church_id}/{user_id}','api\ApiSmLeaveController@saas_myLeaveType');
    // update 1-14-2-2022
    Route::get('member-record/{member_id}','api\ApiStudentRecordController@getRecord');
    Route::get('member-record/{church_id}/{member_id}','api\ApiStudentRecordController@getRecordSaas');

    //class routine
    Route::get('membershiptype-group-routine/{user_id}/{record_id}', 'api\ApiSmClassRoutineController@studentClassRoutine');
    Route::get('school/{church_id}/student-class-routine/{user_id}/{record_id}', 'api\ApiSmClassRoutineController@sassclassRoutine');
    Route::post('member-attendance-store-all', 'api\ApiSmStudentAttendanceController@studentStoreAttendanceAllApi');
    ...
    Route::get('member-payment-installments/{record_id}', 'api\DirectFeesApiController@getInstallments');
    Route::get('member-payment-installment-make-payment/{record_id}', 'api\DirectFeesApiController@makePayment');
    Route::post('member-payment-installment-submit-payment/{record_id}', 'api\DirectFeesApiController@submitPayment');




    Route::post('class-section-subjectList', 'api\ApiSmStudentAttendanceController@subjectList');
    Route::post('member-service-attendance-store', 'api\ApiSmStudentAttendanceController@studentSubjectAttendanceStore');
    Route::get('member-service-attendance/{record_id}', 'api\ApiSmStudentAttendanceController@studentSubjectAttendanceSearch');
    Route::get('member-service-attendance-check', 'api\ApiSmStudentAttendanceController@studentSubjectAttendanceCheck');

    Route::get('member-service-attendance/{user_id}/{record_id}', 'api\ApiSmStudentAttendanceController@studentSubjectAttendanceSearch');
