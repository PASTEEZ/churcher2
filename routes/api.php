...
Route::group(['middleware' => ['XSS','auth:api','json.response']], function () {
   ...
   Route::get('student_list', ['as' => 'student_list', 'uses' => 'SmApiController@studentDetails']);
    Route::get('school/{school_id}/member-list', ['as' => 'saas_student_list', 'uses' => 'SmApiController@saas_studentDetails']);
    ...
    Route::get('school/{school_id}/member-attendance-report', ['as' => 'saas_student_attendance_report', 'uses' => 'api\ApiSmStudentAttendanceController@saas_studentAttendanceReport']);
    ...
    Route::post('school/{school_id}/member-attendance-report-search', ['as' => 'saas_student_attendance_report_search', 'uses' => 'api\ApiSmStudentAttendanceController@saas_studentAttendanceReportSearch']);
    Route::get('member-attendance-report-search', 'api\ApiSmStudentAttendanceController@studentAttendanceReport_search');
    Route::get('school/{school_id}/member-attendance-report-search', 'api\ApiSmStudentAttendanceController@saas_studentAttendanceReport_search');
    ...
    Route::get('school/{school_id}/member-profession', ['as' => 'saas_student_group', 'uses' => 'SmApiController@saas_student_group_index']);
    ...
    Route::get('school/{school_id}/member-profession-edit/{id}', ['as' => 'saas_student_group_edit', 'uses' => 'SmApiController@saas_student_group_edit']);
    ...
    Route::get('school/{school_id}/member-profession-delete/{id}', ['as' => 'saas_student_group_delete', 'uses' => 'SmApiController@saas_student_group_delete']);
    ...
    Route::get('church/{school_id}/class', ['as' => 'saas_class', 'uses' => 'SmApiController@saas_class_index']);
    ...
    Route::get('church/{school_id}/class-edit/{id}', ['as' => 'saas_class_edit', 'uses' => 'SmApiController@saas_class_edit']);
    ...
    Route::get('church/{school_id}/class-delete/{id}', ['as' => 'saas_class_delete', 'uses' => 'SmApiController@saas_class_delete']);
    ...
    Route::get('school/{school_id}/member-dashboard/{id}', 'SmApiController@saas_studentDashboard');
    Route::get('member-my-attendance/{id}/{record_id}', 'api\ApiSmStudentAttendanceController@studentMyAttendanceSearchAPI');
    Route::get('school/{school_id}/member-my-attendance/{id}/{record_id}', 'api\ApiSmStudentAttendanceController@saas_studentMyAttendanceSearchAPI');
    ...
    Route::any('school/{school_id}/search-member', 'api\ApiSmStudentController@saas_searchStudent');
   ...
   Route::get('pending-leave/{user_id}', 'api\ApiSmLeaveController@pendingLeave');
    ...
    // update 1-14-2-2022
    Route::get('member-record/{student_id}','api\ApiStudentRecordController@getRecord');
    Route::get('member-record/{school_id}/{student_id}','api\ApiStudentRecordController@getRecordSaas');
