                ...
                <div class="seat-user">
                    <div class="seat-left" @if(!$setting->student_photo) style="max-width: 100%; padding-right: 0px;" @endif>
                        ...
                        <ul>
                            ...
                            @endif
                            @if($setting->member_id_no)
                                <li>@lang('student.roll_number')
                                    : {{@$seat_plan->studentRecord->studentDetail->member_id_no}}</li>
                            @endif
...
@if($setting->class_section)
        ...
        @endif
        @if($setting->member_id_no)
            <span>@lang('student.roll_number') : {{@$seat_plan->studentRecord->studentDetail->member_id_no}}</span>
