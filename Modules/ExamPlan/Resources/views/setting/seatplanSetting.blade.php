                                ...
                                <div class="white_box_30px mt-5">
                                    ...
                                    <form action="{{ route('examplan.seatplan.settingUpdate') }}" method="post" class="bg-white p-4 rounded">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 d-flex relation-button justify-content-between mb-3">
                                                <p class="text-uppercase mb-0"> @lang('student.member_id_no')</p>
                                                <div class="d-flex radio-btn-flex ml-30 mt-1">
                                                    <div class="mr-20">
                                                        <input type="radio" name="member_id_no"
                                                        id="roll_no_on" value="1"
                                                        class="common-radio relationButton" @if($setting->member_id_no) checked @endif>
                                                    <label
                                                        for="roll_no_on">@lang('examplan::exp.show')</label>
                                                    </div>
                                                    <div class="mr-20">
                                                        <input type="radio" name="member_id_no" id="member_id_no" value="0" class="common-radio relationButton" @if($setting->member_id_no == 0) checked @endif>
                                                        <label for="member_id_no">@lang('examplan::exp.hide')</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 d-flex relation-button justify-content-between mb-3">
