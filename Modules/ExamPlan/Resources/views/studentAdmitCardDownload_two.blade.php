            ...
            <table class="table w-full border p-10">
                <tr>
                    <td>
                        ...
                        <p class="fs-16 fw-bold text-black">@lang('student.registration_number') : <span class="fs-14 fw-bold text-red">{{@$admit->studentRecord->studentDetail->registration_no}}</span></p>
                        @endif 
                    </td>
                    <td class="text-end">
            ...
            <div class="user border p-10 flex">
                <table class="table w-full border">
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            @if($setting->registration_no)
                            <p class="fs-16 fw-bold text-black">@lang('student.roll'): <span class="fs-14 fw-bold text-red">{{@$admit->studentRecord->studentDetail->member_id_no}}</span></p>
                            @endif 
                        </td>
                    </tr>
                </table>
