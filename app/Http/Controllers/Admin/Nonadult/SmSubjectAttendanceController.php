...
class SmSubjectAttendanceController extends Controller
{
...

    {
        ...
        try{
            ...
            $students = StudentRecord::where('age_group_id', $request->class)->where('mgender_id', $request->section)->whereIn('member_id', $activeStudentIds)->where('church_year_id', getAcademicId())->where('church_id',Auth::user()->church_id)->get()->sortBy('member_id_no');
