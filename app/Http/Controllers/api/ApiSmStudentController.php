...
class ApiSmStudentController extends Controller
{
    public function searchStudent(Request $request)
    {
        ...
        $member_ids = StudentRecord::when($request->church_year, function ($query) use ($request) {
            ...
            ->when($request->member_id_no, function ($query) use ($request) {
                $query->where('member_id_no', $request->member_id_no);
            })
        ...
        // ->select('sm_students.id', 'student_photo', 'full_name', 'member_id_no', 'user_id');
