...
class DatatableQueryController extends Controller
{
    public function studentDetailsDatatable(Request $request)
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            return view('backEnd.studentInformation.student_details', compact('classes', 'age_group_id', 'name', 'member_id_no', 'sessions', 'section', 'church_year','data'));
        }
    ...
    public function csmemberDetailsDatatable(Request $request)
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            return view('backEnd.studentInformation.csmember_details', compact('classes', 'age_group_id', 'name', 'member_id_no', 'sessions', 'section', 'church_year','data'));
        }
    ...
    public function jymemberDetailsDatatable(Request $request)
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            return view('backEnd.studentInformation.jymember_details', compact('classes', 'age_group_id', 'name', 'member_id_no', 'sessions', 'section', 'church_year','data'));
        }
