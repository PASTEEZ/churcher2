...
class SmStudentAdmissionController extends Controller
{
    ...
    public function admission()
    {
        ...
        try {
            ...
            $max_admission_id = SmStudent::where('school_id', Auth::user()->school_id)->max('id');
    ...
    public function jymemberDetails(Request $request)
    {
        try {
            ...
            $student_list = DB::table('sm_jymembers')
                ->join('sm_classes', 'sm_jymembers.class_id', '=', 'sm_classes.id')
                ->join('sm_sections', 'sm_jymembers.section_id', '=', 'sm_sections.id')
            ...
            return view('backEnd.studentInformation.jymember_details', compact('classes', 'sessions','students'));
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
