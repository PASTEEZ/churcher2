    ...
    { 
        try {
            if ($role==2) {
                ...
                $body = str_replace('[member_id_no]', @$studentRecord->member_id_no, $body);
                ...
                $body = str_replace('[registration_date]', @$student->registration_date, $body);
                $body = str_replace('[category]', @$student->category->category_name, $body);
                $body = str_replace('[cast]', @$student->home_town, $body);
                ...
                $body = str_replace('[marital_status]', @$student->marital_status->base_setup_name, $body);
